...
\definecolor{OMNIHeaderBlue}{rgb}{0.19, 0.25, 0.38}
...
% OMNI heading 1
\newcommand{\OMNIheadingone}[1]{
  \colorbox{OMNIHeaderBlue}{ % blue heading color
     \makebox[\linewidth][l]{ % create a box that is the length of the text line (This box will contain heading title)
         \textcolor{white}{ % changes the text color to white
             \bfseries{\Huge{#1}} % causes the text to be 25pt font and bold series
         }
     }
  }
}
...
% OMNI heading 2
\newcommand{\OMNIheadingtwo}[1]{
  \fontseries{eb}\selectfont{\LARGE{#1}}
}
